...
namespace RfSimulation {
            ...
            bool isTE) 
    {
        ...
        // Calculate R' using simplified Fresnel equations (assuming that the propagation medium is air)
        ...
        // Calculates phase shift and attenuation the wave experiences bouncing
        // between the front and back of the wall due to its electrical thickness, q, from Equation #44
        ...
        // Resolves the infinite geometric series of the wave bouncing back and forth 
        // internally between the front and back faces of the wall slab
        // to calculate the reflection coefficient according to Equation #43a
